...
```{r}
Raw.Chevron.Trap.Data <- read.csv("~/Desktop/DNR_research/Reef_fish/Data/Raw Chevron Trap Data.csv")
...
```{r}
Video.Data <- read.csv("~/Desktop/DNR_research/Reef_fish/Data/Video Data.csv")
