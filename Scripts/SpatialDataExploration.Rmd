...
Filtering raw chevron trap data into smaller datasets by species and year. 
Right now, starting with just black sea bass and white grunt.
...
```{r}
Raw.Chevron.Trap.Data <- read.csv("~/Desktop/DNR_research/Reef_fish/MSdata/Raw Chevron Trap Data.csv")
...
library(fields)
```
First, bring in video data and use kknn on that.  Then predict values for my data set. 
```{r}
Video.Data <- read.csv("~/Desktop/DNR_research/Reef_fish/MSdata/Video Data.csv")
...
Coast data
```{r}
mp.usa <- map('usa',plot=FALSE,fill=TRUE,col="gray")
data(us.cities)
```
...
newbsb$Max.BD.kknn <- predict(Max.BD.kknn.NoCov, newdata = list(sinlat1 = predict.df$sinlat1))
predict.df2 <- data.frame(dircos(newwg[,c("Long", "Lat")]))
newwg$Max.BD.kknn <-predict(Max.BD.kknn.NoCov, newdata = list(sinlat1 =predict.df2$sinlat1))
```
Mean biota density
```{r}
test <- data.frame(dircos(BD.data[,c("Longitude", "Latitude")]))
...
predict.df <- data.frame(dircos(newbsb[,c("Long","Lat")]))
newbsb$Mean.BD.kknn <- predict(Mean.BD.kknn.NoCov, newdata = list(sinlat1 = predict.df$sinlat1))
predict.df2 <- data.frame(dircos(newwg[,c("Long","Lat")]))
newwg$Mean.BD.kknn <- predict(Mean.BD.kknn.NoCov, newdata = list(sinlat1 = predict.df2$sinlat1))
```
Biota Height
```{r}
...
predict.df <- data.frame(dircos(newbsb[,c("Long","Lat")]))
newbsb$BH.kknn <- predict(BH.kknn.NoCov, newdata = list(sinlat1 = predict.df$sinlat1))
predict.df2 <- data.frame(dircos(newwg[,c("Long","Lat")]))
newwg$BH.kknn <- predict(BH.kknn.NoCov, newdata = list(sinlat1 = predict.df2$sinlat1))
```
Max Substrate Density
```{r}
...
predict.df <- data.frame(dircos(newbsb[,c("Long","Lat")]))
newbsb$Max.SD.kknn <- predict(Max.SD.kknn.NoCov, newdata = list(sinlat1 = predict.df$sinlat1))
predict.df2 <- data.frame(dircos(newwg[,c("Long","Lat")]))
newwg$Max.SD.kknn <- predict(Max.SD.kknn.NoCov, newdata = list(sinlat1 = predict.df2$sinlat1))
```
...
predict.df <- data.frame(dircos(newbsb[,c("Long","Lat")]))
newbsb$Mean.SD.kknn <- predict(Mean.SD.kknn.NoCov, newdata = list(sinlat1 = predict.df$sinlat1))
predict.df2 <- data.frame(dircos(newwg[,c("Long","Lat")]))
newwg$Mean.SD.kknn <- predict(Mean.SD.kknn.NoCov, newdata = list(sinlat1 = predict.df2$sinlat1))
```
Substrate Size
```{r}
...
predict.df <- data.frame(dircos(newbsb[,c("Long","Lat")]))
newbsb$SS.kknn <- predict(SS.kknn.NoCov, newdata = list(sinlat1 = predict.df$sinlat1))
predict.df2 <- data.frame(dircos(newwg[,c("Long","Lat")]))
newwg$SS.kknn <- predict(SS.kknn.NoCov, newdata = list(sinlat1 = predict.df2$sinlat1))
```
Substrate Relief
```{r}
...
predict.df <- data.frame(dircos(newbsb[,c("Long","Lat")]))
newbsb$SR.kknn <- predict(SR.kknn.NoCov, newdata = list(sinlat1 = predict.df$sinlat1))
predict.df2 <- data.frame(dircos(newwg[,c("Long","Lat")]))
newwg$SR.kknn <- predict(SR.kknn.NoCov, newdata = list(sinlat1 = predict.df2$sinlat1))
```
